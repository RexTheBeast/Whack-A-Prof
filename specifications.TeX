...
\begin{center}
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
        Jack Kaplan & Mar 12 2025 & Initial draft & 1.0\\
        \hline
    \end{tabular}
\end{center}
...
\begin{itemize}
    ...
    \item \textbf{REQ-1.2:} Trustee explosion animation clearly visualized with a visceral effect lasting around 1 second.
\end{itemize}
