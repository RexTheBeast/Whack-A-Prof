...
\begin{itemize}
  ...
  \item \emph{Resolution}:
    \begin{itemize}
      \item Minimum supported: 1024 × 768 px
      \item Optimized for: 1280 x 720 px, 1366 × 768 px, 1920 × 1080 px
      \item Mobile support: Responsive layout for screens $\geq$ 375 × 667 px
      \item High-DPI screens (e.g., Retina) supported
    \end{itemize}
\end{itemize}
